...
from apps.api.views import (
    ...
    strategy_set_value_view, strategy_delete_key_view)
...
urlpatterns = [
    ...
    url(r'^strategy/(?P<strategy_uuid>[\w.@+-]+)/edit/$', strategy_set_value_view,
        name='strategy_set_value_view'),
    url(r'^strategy/(?P<strategy_uuid>[\w.@+-]+)/delete/$', strategy_delete_key_view,
